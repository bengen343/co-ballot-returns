...
return_zip = r'2024_June_State_CE-068_Voters_With_Ballots_List_Public_FINAL.zip'
return_txt_file = r'2024_June_State_CE-068_Voters_With_Ballots_List_Public_FINAL.txt'
# Secret variables
