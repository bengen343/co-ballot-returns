...
bq_voter_str = 'SELECT VOTER_ID, COUNTY, LAST_NAME, FIRST_NAME, MIDDLE_NAME, NAME_SUFFIX, RESIDENTIAL_CITY, BIRTH_YEAR, GENDER ,PRECINCT, PARTY, PREFERENCE, CONGRESSIONAL, STATE_SENATE, STATE_HOUSE FROM `' + bq_table_id + '`'

bq_history_str = 'SELECT * FROM `' + bq_table_id + '` WHERE ELECTION_DATE IN (' + election_str + ') OR ELECTION_DATE IS NULL'
